...
namespace CredentialScanner.Services
{
    public class ConfigService
    {
        ...
        public string FirebaseProjectId => GetValue("FIREBASE_SETTINGS", "PROJECT_ID", "miatech-sentinel");
        public string ApiUrl => GetValue("API_SETTINGS", "API_URL", "http://localhost:3000/api/v1");
    }
}